...
def get_api_context(context):
    ...
    if not hasattr(context, 'api_context'):
        ...
        config = {"defaults": {"baseUrl": "https://jsonplaceholder.typicode.com", "headers": {"Content-Type": "application/json", "User-Agent": "FlowSphere/1.0"}, "timeout": 30, "validations": [{"httpStatusCode": 200}]}, "description": "Basic GET and POST requests", "enableDebug": false, "name": "Simple API Test", "nodes": [{"id": "get_post", "method": "GET", "name": "Get a single post", "url": "/posts/1"}, {"body": {"body": "This is a test post", "title": "Test Post", "userId": 1}, "id": "create_post", "method": "POST", "name": "Create a new post", "url": "/posts", "validations": [{"httpStatusCode": 201}, {"field": "title", "value": "Test Post"}]}, {"id": "get_all_posts", "method": "GET", "name": "Get all posts", "url": "/posts"}]}
